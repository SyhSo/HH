...
public class GameManager : MonoBehaviour
{
    ...
    public void Shooting(Vector3 targetPosition,Enemy enemy, AudioSource weaponSound, AudioClip shootingSound)   
    {
       ...
       GameObject prefapToSpawn = PoolManager.instance.ActivateObj(0);
       SetObjPosition(prefapToSpawn,bulletPoint);
       prefapToSpawn.transform.rotation = Quaternion.LookRotation(aim, Vector3.up);
    ...
    {
        //Instantiate(enemy, spawnPoint[UnityEngine.Random.Range(0, spawnPoint.Length)].transform.position, Quaternion.identity);
        GameObject enemy = PoolManager.instance.ActivateObj(4);
        SetObjPosition(enemy, spawnPoint[UnityEngine.Random.Range(0, spawnPoint.Length)].transform);
