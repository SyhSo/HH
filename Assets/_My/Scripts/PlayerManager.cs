...
public class PlayerManager : MonoBehaviour
{
    ...
    private void AimCheck()
    {
        ...
        if (input.aim)
        {
            ...
            {
                targetPosition = camTransform.position + camTransform.forward * aimObgDis;
                aimObj.transform.position = camTransform.position + camTransform.forward * aimObgDis;
            }
